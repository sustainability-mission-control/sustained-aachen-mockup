      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold">Sustained Aachen</span>
            </div>
            <p className="mt-4 text-neutral-300 text-sm">
              A community-driven platform for sustainability initiatives in Aachen, 
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                <input
                  ...
                  className="px-3 py-2 placeholder-neutral-400 text-neutral-900 rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary-500 flex-1"
                />
                <button
                  type="button"
        ...
        <div className="mt-12 border-t border-neutral-700 pt-8 flex flex-col md:flex-row justify-between">
          ...
          <p className="text-sm text-neutral-400 mt-2 md:mt-0">
            Powered by community contributions and quadratic funding.
          </p>
        </div>
      </div>
    </footer>
